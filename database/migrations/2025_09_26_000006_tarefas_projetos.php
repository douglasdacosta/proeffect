...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tarefas_projetos', function (Blueprint $table) {
            $table->id();
            $table->foreignId('projetos_id')->constrained('projetos')->onDelete('cascade');
...
/**
    ...
    public function down()   {
        Schema::dropIfExists('tarefas_projetos');
    }
};
