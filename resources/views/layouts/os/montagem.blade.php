<div id="imprimir" class="contenedor">
    <table class="table text-center">
        ...
        @endfor
       <tr>
            <td colspan="2" rowspan="3" class="font-weight-bold ">
                <p class='top_texto_qualidade'>Alertas de qualidade</p>
            </td>
            <td colspan="9">@if ($folha['alerta1']) {{$folha['alerta1']}} @else &nbsp; @endif</td>
        </tr>
        <tr>
            <td colspan="9">@if ($folha['alerta2']) {{$folha['alerta2']}} @else &nbsp; @endif @if ($folha['alerta4']) {{$folha['alerta4']}} @else &nbsp; @endif</td>
        </tr>
         <tr>
            <td colspan="9">
                @if ($folha['alerta3']) {{$folha['alerta3']}} @else &nbsp; @endif
                @if ($folha['alerta5']) {{$folha['alerta5']}} @else &nbsp; @endif
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>01</td>
            <td colspan="3" style="padding-top: 22px;">Foi efetuada a verificação dos Alertas de Qualidade?</td>
            <td></td>
            <td></td>
            <td colspan="2"></td>
            <td></td>
        ...
        <tr>
            <td>02</td>
            <td colspan="3">Verificar nos desenhos se existem; alertas, avisos ou  operações e assinalar em amarelo e carimbar</td>
            <td></td>
            <td></td>
            <td colspan="2"></td>
            <td></td>
        ...
        <tr>
            <td>03</td>
            <td colspan="3">Fazer lote 5 peças e verificar se as operações estão corretas conforme desenho.</td>
            <td></td>
            <td></td>
            <td colspan="2"></td>
            <td></td>
        ...
        <tr>
            <td>04</td>
            <td colspan="3" style="padding-top: 19px;">Quantidade Correta?</td>
            <td></td>
            <td></td>
            <td colspan="2"></td>
            <td></td>
        ...
        <tr>
            <td>05</td>
            <td colspan="3"  style="padding-top: 19px;">Carimbar folha de processo correspondente a montagem</td>
            <td></td>
            <td></td>
            <td colspan="2"></td>
            <td></td>
