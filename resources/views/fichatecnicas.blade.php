...
@else
    @section('content')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-1">
                <input type="text" id="blank" name="blank" class="form-control col-md-13 text-uppercase" value="">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" id="alerta_usinagem1" name="alerta_usinagem1" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_usinagem1)) {{$fichatecnicas[0]->alerta_usinagem1}} @else{{ '' }}@endif">
                <input type="text" id="alerta_usinagem2" name="alerta_usinagem2" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_usinagem2)) {{$fichatecnicas[0]->alerta_usinagem2}} @else{{ '' }}@endif">
                <input type="text" id="alerta_usinagem3" name="alerta_usinagem3" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_usinagem3)) {{$fichatecnicas[0]->alerta_usinagem3}} @else{{ '' }}@endif">
                <input type="text" id="alerta_usinagem4" name="alerta_usinagem4" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_usinagem4)) {{$fichatecnicas[0]->alerta_usinagem4}} @else{{ '' }}@endif">
                <input type="text" id="alerta_usinagem5" name="alerta_usinagem5" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_usinagem5)) {{$fichatecnicas[0]->alerta_usinagem5}} @else{{ '' }}@endif">
            </div>
        </div>
        <div class="form-group row">
            <label for="alerta_acabamento" class="col-sm-2 col-form-label text-right">Alerta acabamento</label>
            <div class="col-sm-10">
                <input type="text" id="alerta_acabamento1" name="alerta_acabamento1" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_acabamento1)) {{$fichatecnicas[0]->alerta_acabamento1}} @else{{ '' }}@endif">
                <input type="text" id="alerta_acabamento2" name="alerta_acabamento2" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_acabamento2)) {{$fichatecnicas[0]->alerta_acabamento2}} @else{{ '' }}@endif">
                <input type="text" id="alerta_acabamento3" name="alerta_acabamento3" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_acabamento3)) {{$fichatecnicas[0]->alerta_acabamento3}} @else{{ '' }}@endif">
                <input type="text" id="alerta_acabamento4" name="alerta_acabamento4" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_acabamento4)) {{$fichatecnicas[0]->alerta_acabamento4}} @else{{ '' }}@endif">
                <input type="text" id="alerta_acabamento5" name="alerta_acabamento5" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_acabamento5)) {{$fichatecnicas[0]->alerta_acabamento5}} @else{{ '' }}@endif">
            </div>
        </div>
        <div class="form-group row">
            <label for="alerta_montagem" class="col-sm-2 col-form-label text-right">Alerta montagem</label>
            <div class="col-sm-10">
                <input type="text" id="alerta_montagem1" name="alerta_montagem1" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_montagem1)) {{$fichatecnicas[0]->alerta_montagem1}} @else{{ '' }}@endif">
                <input type="text" id="alerta_montagem2" name="alerta_montagem2" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_montagem2)) {{$fichatecnicas[0]->alerta_montagem2}} @else{{ '' }}@endif">
                <input type="text" id="alerta_montagem3" name="alerta_montagem3" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_montagem3)) {{$fichatecnicas[0]->alerta_montagem3}} @else{{ '' }}@endif">
                <input type="text" id="alerta_montagem4" name="alerta_montagem4" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_montagem4)) {{$fichatecnicas[0]->alerta_montagem4}} @else{{ '' }}@endif">
                <input type="text" id="alerta_montagem5" name="alerta_montagem5" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_montagem5)) {{$fichatecnicas[0]->alerta_montagem5}} @else{{ '' }}@endif">
            </div>
        </div>
        <div class="form-group row">
            <label for="alerta_inspecao" class="col-sm-2 col-form-label text-right">Alerta inspeção</label>
            <div class="col-sm-10">
                <input type="text" id="alerta_inspecao1" name="alerta_inspecao1" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_inspecao1)) {{$fichatecnicas[0]->alerta_inspecao1}} @else{{ '' }}@endif">
                <input type="text" id="alerta_inspecao2" name="alerta_inspecao2" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_inspecao2)) {{$fichatecnicas[0]->alerta_inspecao2}} @else{{ '' }}@endif">
                <input type="text" id="alerta_inspecao3" name="alerta_inspecao3" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_inspecao3)) {{$fichatecnicas[0]->alerta_inspecao3}} @else{{ '' }}@endif">
                <input type="text" id="alerta_inspecao4" name="alerta_inspecao4" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_inspecao4)) {{$fichatecnicas[0]->alerta_inspecao4}} @else{{ '' }}@endif">
                <input type="text" id="alerta_inspecao5" name="alerta_inspecao5" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_inspecao5)) {{$fichatecnicas[0]->alerta_inspecao5}} @else{{ '' }}@endif">
            </div>
        </div>
        <div class="form-group row">
            <label for="alerta_expedicao" class="col-sm-2 col-form-label text-right">Alerta expedição</label>
            <div class="col-sm-10">
                <input type="text" id="alerta_expedicao1" name="alerta_expedicao1" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_expedicao1)) {{$fichatecnicas[0]->alerta_expedicao1}} @else{{ '' }}@endif">
                <input type="text" id="alerta_expedicao2" name="alerta_expedicao2" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_expedicao2)) {{$fichatecnicas[0]->alerta_expedicao2}} @else{{ '' }}@endif">
                <input type="text" id="alerta_expedicao3" name="alerta_expedicao3" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_expedicao3)) {{$fichatecnicas[0]->alerta_expedicao3}} @else{{ '' }}@endif">
                <input type="text" id="alerta_expedicao4" name="alerta_expedicao4" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_expedicao4)) {{$fichatecnicas[0]->alerta_expedicao4}} @else{{ '' }}@endif">
                <input type="text" id="alerta_expedicao5" name="alerta_expedicao5" class="form-control col-md-13" value="@if (isset($fichatecnicas[0]->alerta_expedicao5)) {{$fichatecnicas[0]->alerta_expedicao5}} @else{{ '' }}@endif">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <select class="form-control col-md-1" id="status" name="status">
                ...
                <option value="I" @if (isset($fichatecnicas[0]->status) && $fichatecnicas[0]->status =='I'){{ ' selected '}}@else @endif>Inativo</option>
            </select>
        </div>
        <div class="form-group row">
            <div class="col-sm-10">
