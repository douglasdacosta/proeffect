                        ...
                        <tbody>
                            ...
                            @foreach ($dado_pedido_status['classe'] as $pedido)
                                ...
                                <tr>
                                    ...
                                    <td>{{ ($dado_pedido_status['pedido'][$pedido->id]['totais']['subTotalMO'] == 0 || strtotime($dado_pedido_status['pedido'][$pedido->id]['usinagem']) == 0) ? 0 : (DateHelpers::formatFloatValue($dado_pedido_status['pedido'][$pedido->id]['totais']['subTotalMO'])*60)/(strtotime($dado_pedido_status['pedido'][$pedido->id]['usinagem'])/60) }}</td>
                                    <td title="{{$pedido->tabelaTransportes->nome}}">{!! Str::words($pedido->tabelaTransportes->nome, 2, '...') !!}</td>
                                    <td>{{ $pedido->tabelaStatus->nome }}</td>
                                    <td>{{ PedidosController::formatarHoraMinuto($dado_pedido_status['pedido'][$pedido->id]['usinagem']) }}
                                    </td>
